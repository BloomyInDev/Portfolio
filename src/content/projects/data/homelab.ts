...
export default {
    ...
    description: [
        ...
        "",
        "Mon homelab est actuellement composé de 3 machines physiques, que je prévois de consolider bientôt. Ces machines sont uniquement de la récupération d'ancien matériel qui allait être jeté. Cette configuration me permet d'avoir une grande flexibilité pour héberger différents types de services, tout en me donnant l'opportunité d'apprendre à gérer et à optimiser les ressources de mon homelab.",
        "",
        (
            [
                {
                    name: "ronflex",
                    explaination:
                        "ma machine principale. Elle est composée d'un i3 7100, de 32Go de RAM, d'1To+128Go de stockage en SSD SATA et tourne sous Debian 13. Il héberge la quasi totalité de mon infrastructure, étant donné que c'est la machine la plus performante que j'ai.",
                    services: [
                ...
                },
                {
                    name: "givrali",
                    explaination:
                        "une machine qui était sensé être temporaire, mais qui est reste toujours en place. Elle est composée d'un i7 3537U, de 8Go de RAM, de 128Go de stockage en SSD SATA et tourne sous Arch Linux (étant donné que c'était sensé être temporaire). Elle héberge très peu de services, étant donné ses performances limitées, mais elle me sert de machine de test pour des projets qui pourraient poser des problèmes à ma machine principale.",
                    services: [
                ...
                },
                {
                    name: "salameche",
                    explaination:
                        "une machine qui est temporaire, elle sert a fournir une petite machine pour des copains de manière extremement temporaire. Elle est composée d'un Pentium N3540, de 4Go de RAM, de 256Go de SSD SATA et tourne sous Debian 13. Elle a fait tourner que des petits services parce qu'elle est très peu puissante",
                    services: [
